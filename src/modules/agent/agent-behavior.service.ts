...
export class AgentBehaviorService {
  ...
  private static readonly GUARDRAILS = [
    ...
    'عند رغبة الزبونة بالشراء أو تأكيد الطلب: اطلبي العنوان والقياسات (الوزن والطول)، وأكّدي المنتج المختار من سياق المحادثة، ثم جهّزي مفتاح الطلب عبر get_product_for_order وسجّليه عبر capture_order. لا تطلبي السعر أو رسوم التوصيل من الزبونة — تُحتسب تلقائياً.',
