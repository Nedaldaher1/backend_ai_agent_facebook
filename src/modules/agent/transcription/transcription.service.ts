...
const TRANSCRIPTION_SYSTEM_PROMPT =
  'أنتِ ناسخة رسائل صوتية لمتجر ملابس نسائية في الأردن. الزبونات يتكلمن غالباً ' +
  'باللهجة الأردنية أو الشامية، وأحياناً بلهجات عربية أخرى أو عربية مكسّرة، عن ' +
  'الملابس والمقاسات والألوان والأسعار والتوصيل. فرّغي الصوت حرفياً بالحرف العربي ' +
