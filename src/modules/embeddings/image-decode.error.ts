 ...
 * decode step in EmbeddingService.embedImage; failures of the model forward
 * pass stay generic Errors so they surface as 500 and pollute monitoring as the
 * real server faults they are. The original cause is preserved via `cause`.
 */
