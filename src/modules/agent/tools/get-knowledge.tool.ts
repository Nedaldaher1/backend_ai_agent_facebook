...
export function buildGetKnowledgeTool(knowledge: KnowledgeService) {
  return createTool({
    id: 'get_knowledge',
    description:
      'ابحثي في قاعدة معرفة متجر ماسة عن معلومات الشحن والإرجاع والمقاسات والدفع وسياسات المتجر والعناية بالقماش والأسئلة الشائعة. استخدمي هذه الأداة قبل الإجابة على أي سؤال يتعلق بسياسات المتجر.',
    inputSchema,
    outputSchema,
